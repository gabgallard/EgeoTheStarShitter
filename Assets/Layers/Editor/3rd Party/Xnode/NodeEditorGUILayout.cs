...
namespace ABXY.Layers.Editor.ThirdParty.Xnode {
    ...
    public static class NodeEditorGUILayout {
        ...
        /// <summary> Draws an input and an output port on the same line </summary>
        public static void PortPair(GUIContent inputLabel, NodePort input, GUIContent outputLabel, NodePort output)
        {
            GUILayout.BeginHorizontal();
        ...
        /// <summary> Draws an input and an output port on the same line </summary>
        public static void PortPair(NodePort input, GUIContent label, NodePort output)
        {
            GUILayout.BeginHorizontal();
        ...
        public static void PropertyAndPortPair(SerializedObject so, NodePort input, NodePort output)
        {
            Node.ShowBackingValue showBacking = Node.ShowBackingValue.Unconnected;
            Node.InputAttribute inputAttribute;
            bool dynamicPortList = false;
            ...
            bool usePropertyAttributes = dynamicPortList ||
                showBacking == Node.ShowBackingValue.Never ||
                (showBacking == Node.ShowBackingValue.Unconnected && input.IsConnected);
